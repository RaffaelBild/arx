...
public class DataDependentEDDPAlgorithm extends AbstractAlgorithm{
    ...
    public boolean traverse() {
        ...
        bestTransformation.setChecked(checker.check(bestTransformation, true, ScoreType.CONVENTIONAL));
        System.out.println(bestTransformation.getInformationLoss().toString());
        return false;
    }
