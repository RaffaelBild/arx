...
public class TestAnonymizationDifferentialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createAECSMetric()).addCriterion(new EDDifferentialPrivacy(0.9d, 1E-5d, 1d, 10, true)), "./data/adult.csv", 747.875, new int[] { 0, 3, 1, 2, 3, 2, 2, 1, 1 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createLossMetric()).addCriterion(new EDDifferentialPrivacy(0.9d, 1E-5d, 1d, 10, true)), "./data/adult.csv", 0.6880872033117096, new int[] { 1, 3, 0, 2, 2, 2, 2, 2, 1 }, false) },
                                              /* 20 */ { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createPrecisionMetric()).addCriterion(new EDDifferentialPrivacy(0.9d, 1E-5d, 1d, 10, true)), "./data/adult.csv", 0.589773390862588, new int[] { 0, 3, 0, 2, 2, 1, 2, 2, 0 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createDiscernabilityMetric()).addCriterion(new EDDifferentialPrivacy(0.9d, 1E-5d, 1d, 10, true)), "./data/adult.csv", 2.1844143E7, new int[] { 1, 1, 1, 1, 3, 2, 2, 2, 1 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createEntropyMetric()).addCriterion(new EDDifferentialPrivacy(0.9d, 1E-5d, 1d, 10, true)), "./data/adult.csv", 235748.7244642646, new int[] { 0, 3, 0, 1, 2, 2, 2, 1, 1 }, false) },
        });
    }
